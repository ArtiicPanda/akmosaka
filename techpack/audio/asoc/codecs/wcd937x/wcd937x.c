...
const struct soc_enum wc937x_tx_master_ch_enum =
...
static const struct snd_kcontrol_new wcd937x_snd_controls[] = {
	...
	SOC_SINGLE_TLV("ADC3 Volume", WCD937X_ANA_TX_CH3, 0, 20, 0,
			analog_gain),
	SOC_ENUM_EXT("ADC1 ChMap", wc937x_tx_master_ch_enum,
			wcd937x_tx_master_ch_get, wcd937x_tx_master_ch_put),
	SOC_ENUM_EXT("ADC2 ChMap", wc937x_tx_master_ch_enum,
			wcd937x_tx_master_ch_get, wcd937x_tx_master_ch_put),
	SOC_ENUM_EXT("ADC3 ChMap", wc937x_tx_master_ch_enum,
			wcd937x_tx_master_ch_get, wcd937x_tx_master_ch_put),
	SOC_ENUM_EXT("DMIC0 ChMap", wc937x_tx_master_ch_enum,
			wcd937x_tx_master_ch_get, wcd937x_tx_master_ch_put),
	SOC_ENUM_EXT("DMIC1 ChMap", wc937x_tx_master_ch_enum,
			wcd937x_tx_master_ch_get, wcd937x_tx_master_ch_put),
	SOC_ENUM_EXT("MBHC ChMap", wc937x_tx_master_ch_enum,
			wcd937x_tx_master_ch_get, wcd937x_tx_master_ch_put),
	SOC_ENUM_EXT("DMIC2 ChMap", wc937x_tx_master_ch_enum,
			wcd937x_tx_master_ch_get, wcd937x_tx_master_ch_put),
	SOC_ENUM_EXT("DMIC3 ChMap", wc937x_tx_master_ch_enum,
			wcd937x_tx_master_ch_get, wcd937x_tx_master_ch_put),
	SOC_ENUM_EXT("DMIC4 ChMap", wc937x_tx_master_ch_enum,
			wcd937x_tx_master_ch_get, wcd937x_tx_master_ch_put),
	SOC_ENUM_EXT("DMIC5 ChMap", wc937x_tx_master_ch_enum,
			wcd937x_tx_master_ch_get, wcd937x_tx_master_ch_put),
